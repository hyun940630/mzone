...
<html>
  <head>
    ...
    <link rel="stylesheet" media="(max-device-width: 768px)" href="./styles/base_mobile.css?ver=4">
    <link rel="stylesheet" media="(max-device-width: 768px)" href="./styles/header_mobile.css?ver=3">
    <link rel="stylesheet" media="(max-device-width: 768px)" href="./styles/tailer_mobile.css">

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <script src="./scripts/header.js?ver=3"></script>
